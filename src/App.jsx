  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-yellow-400 border-b-4 border-black z-50 h-20 flex items-center shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full flex justify-between items-center font-black">
        ...
        <a href="#contact" className="bg-red-600 text-white border-4 border-black px-6 py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 transition-all active:scale-95 flex items-center justify-center">立即報名</a>
      </div>
    </nav>
  );
}
  ...
  return (
    <section className="relative pt-40 pb-24 bg-cyan-400 border-b-8 border-black overflow-hidden px-4 text-center comic-bg">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="bg-white border-4 border-black comic-shadow p-8 max-w-3xl mx-auto transform rotate-1 hover:rotate-0 transition-transform text-black font-bold">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 text-black">
          {schools.map((s, i) => (
            <div key={i} className="bg-white border-4 border-black comic-shadow flex flex-col h-full transform hover:-translate-y-4 hover:rotate-1 transition-all relative group">
              ...
              <a href={s.link} target="_blank" rel="noopener noreferrer" className="bg-black text-white text-center py-4 font-black uppercase text-sm hover:bg-red-600 transition-colors tracking-widest flex items-center justify-center">進入官網 ➔</a>
            </div>
          ))}
        </div>
      </div>
...
function TimelineSection() {
  ...
  const steps = [
    ...
    { date: "03月", title: "入學面試", tasks: "各校安排視訊或面試學員學員。展現學習意願。" },
    ...
    <section id="contact" className="py-24 bg-cyan-400 border-b-8 border-black halftone-bg px-4 text-center text-black">
      ...
      <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
        <div className="bg-green-400 border-4 border-black p-10 comic-shadow transform hover:rotate-2 transition-transform group text-black">
          ...
          <a href="https://wa.me/639989195808" target="_blank" className="block bg-white border-4 border-black py-4 font-black text-2xl hover:bg-yellow-400 transition-all uppercase flex items-center justify-center">WhatsApp 直接對話</a>
        </div>
